...
```  
可打开GUI界面，运行后得到测试结果:
![pipe-nt-Processor](https://github.com/DesmondoRay/CSAPP/blob/master/chapter_4/4.55/Processor.png)
![pipe-nt-Processor](https://github.com/DesmondoRay/CSAPP/blob/master/chapter_4/4.55/Memory%20Contents.png)